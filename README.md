...
[![Build status](https://img.shields.io/github/actions/workflow/status/ivkond-mc/easy-homes/gradle-publish.yml?branch=release/1.21.1)](https://github.com/ivkond-mc/easy-homes/actions/workflows/gradle-publish.yml?branch=release/1.21.1)
